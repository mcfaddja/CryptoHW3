...
% Since we have $\phi \left( p^e \right) = \lvert \Z_{p^e}^\star \rvert$, by the definitions of $\phi \left( \mathfrak{p} \right)$ and $\Z_{\mathfrak{p}}^\star$ for any prime $\mathfrak{p}$,
% 
% \begin{align*}
