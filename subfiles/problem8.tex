...
We now subtract the equation in \ref{eq8d2} from the equation in \ref{eq8d1} to obtain 
...
\begin{align*}
  ...
  &\Bigl. \qquad \qquad \qquad \quad - \Pr \left[ \mathcal{A} \left( pk,  \text{{\fontfamily{phv}\selectfont Enc}}_{pk} \left( m_{1, 1} \right), \text{{\fontfamily{phv}\selectfont Enc}}_{pk} \left( m_{2, 1} \right) \right) = 1 \right] \Bigr\} \leq \\
  &\qquad \leq \left( \frac{1}{2} + \text{{\fontfamily{phv}\selectfont negl}}_0 \left( n \right) \right) - \left( \frac{1}{2} + \text{{\fontfamily{phv}\selectfont negl}}_10 \left( n \right) \right) \\
  &\qquad \leq \text{{\fontfamily{phv}\selectfont negl}}_0 \left( n \right) - \text{{\fontfamily{phv}\selectfont negl}}_1 \left( n \right)
\end{align*}
...
Since we will eventually make use of the security definition in \ref{eq8a}, we differentiate  the expressions in \ref{eq8b1} and \ref{eq8b2}
